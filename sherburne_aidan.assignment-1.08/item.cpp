...
item::item(object_description &o, pair_t pos)
    : odesc(o), name(o.get_name()), description(o.get_description()),
      type(o.get_type()), color(o.get_color()), hit(o.get_hit().roll()),
      damage(o.get_damage()), dodge(o.get_dodge().roll()),
      def(o.get_defence().roll()), weight(o.get_weight().roll()),
      speed(o.get_speed().roll()), attr(o.get_attribute().roll()),
